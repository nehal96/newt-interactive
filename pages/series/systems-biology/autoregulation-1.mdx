...
As an example, below is a comparison between a 'real' network and a random network for 14 nodes and 20 arrows (in mathematics, these 'arrows', or connections, are called edges). Try regenerating the random network to see different possibilities. Take note of the number of self-looped arrows in the random one &mdash; how many are usually there, and how does it compare to the 'real' one?

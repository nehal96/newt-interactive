...
The response time of negative autoregulation here is about 5x as fast as simple regulation.
...
Speeding up responses is one of the key advantages of negative autoregulation. In the next article, and the final part on autoregulation, we'll explore another major one: robustness.

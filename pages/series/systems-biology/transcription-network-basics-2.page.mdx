...
import { ActivatorTutorial, RepressorTutorial } from "./figures";

export const metadata = {
  title: "Transcription Network Basics: Part Two",
  subtitle: "Activators, repressors, and how to model gene expression",
  ...
  url: "https://www.newtinteractive.com/series/systems-biology/transcription-network-basics-2",

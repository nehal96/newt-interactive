import { MdxLayout, PostArticleSubscribe, PreviousArticleLink, NextArticleLink, ArticleNavigationContainer } from "@ui/article";
...
import { ImageSeries, Quote, UnorderedList } from "@ui/prose";
import MathFormula from "@ui/prose/MathFormula";
import { VisuallyHidden } from "@radix-ui/react-visually-hidden";
import { AutoregulationNetworkComparisonTutorial } from "./figures";
import ErdosRenyiGNMNetwork from "@viz/flow/RandomGraphExplorer";
...
We'll explore this question in the next article. For now, feel free to play around with an Erdős-Rényi network generator below and see how the network changes when you change some parameters. You can also check it out in the [Erdős-Rényi Graphs block](/blocks/erdos-renyi-graph).

import { ImageSeries, MathFormula, MdxLayout, Tooltip, TooltipContent } from "../../../components";
...
<div className="flex flex-col justify-center mt-4 mb-12 mx-auto">
  <MathFormula variant="popover" className="md:text-lg" tex="f(X^*, Y^*) = \beta \cdot \theta(X^* > K_X) \cdot \theta(Y^* > K_Y)" />
</div>
...
<div className="flex flex-col justify-center mt-4 mb-12 mx-auto">
  <MathFormula variant="popover" className="md:text-lg" tex="f(X^*, Y^*) = \beta \cdot \theta(X^* > K_X \hspace{0.75em} \text{OR} \hspace{0.75em} Y^* > K_Y)" />
</div>
...
If we keep the removal rate <MathFormula tex="\alpha" /> constant, the higher the production rate <MathFormula tex="\beta" />, the higher the steady state concentration is. Keep <MathFormula tex="\beta" /> constant, and a higher removal rate <MathFormula tex="\alpha" /> will result in a lower <MathFormula tex="Y_{st}" />.

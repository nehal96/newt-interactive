...
<div className="flex flex-col justify-center mt-4 mb-12 mx-auto">
  <MathFormula tex="f(X^*, Y^*) = \beta \cdot \theta(X^* > K_X) \cdot \theta(Y^* > K_Y) \qquad \text{\textasciitilde} X^* \text{ AND } Y^*" />
</div>
...
<div className="flex flex-col justify-center mt-4 mb-12 mx-auto">
  <MathFormula tex="f(X^*, Y^*) = \beta \cdot \theta(X^* > K_X \hspace{0.75em} \text{OR} \hspace{0.75em} Y^* > K_Y) \qquad \text{\textasciitilde} X^* \text{ OR } Y^*" />
</div>

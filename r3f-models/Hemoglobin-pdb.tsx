...
Command: npx gltfjsx@6.5.0 hemoglobin-pdb.gltf --types 
*/
...
export default function Model(props: JSX.IntrinsicElements["group"]) {
  const { nodes, materials } = useGLTF("/hemoglobin-pdb.gltf") as GLTFResult;
  return (
    <group {...props} dispose={null}>
      <mesh
        geometry={nodes.mesh_0.geometry}
        material={nodes.mesh_0.material}
        position={[-15.223, -0.565, -13.758]}
      />
      <mesh
...
useGLTF.preload("/hemoglobin-pdb.gltf");
